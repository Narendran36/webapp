pipeline {
  ...
  stages {
    ...
    stage ('Upload Reports to Defect Dojo') {
			...
			sh 'python upload-results.py --host 127.0.0.1:8000 --api_key d2c8bbacea83c3e5ae7e818ef44d8b3a251878a5 --engagement_id 4 --result_file zap-report.xml --username admin --scanner "ZAP Scan"'
