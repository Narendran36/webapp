pipeline {
  ...
  stages {
    ...
    stage ('Upload Reports to Defect Dojo') {
			...
			sh 'python upload-results.py --host 127.0.0.1:8000 --api_key 36b0b85239241be4f9140dadfe85d2b70425a8fd --engagement_id 4 --result_file zap-report.xml --username admin'
		    }
	    }  
